...
* http://github.com/Enlighten/preferences

Source

* git://github.com/Enlighten/preferences.git
...
Add the correct version of the gem to your Gemfile:

'~> 0.6.3' for Rails 4.1 and lower
'~> 0.7.0' for Rails 4.2.x

Eventually, we'll need an 0.8.0 branch for Rails 5.
